  ...
  return (
    <>
    {
      ...
      <div className="h-screen w-screen fixed top-0 left-0 bg-black/50 z-50 backdrop-blur-sm">
        ...
        {/* Form Section */}
        <div className="mt-4"> 
           <input type="text"  placeholder="Name" name="" id="" className="form-input"/> 
           <input type="text"  placeholder="Email" name="" id="" className="form-input"/> 
           <input type="text"  placeholder="Address" name="" id="" className="form-input"/> 
